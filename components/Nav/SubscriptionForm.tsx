		...
		<div className="mr-28 mt-4 flex flex-grow flex-col justify-start lg:mt-0">
			...
			>
				...
				<button
					...
					ref={buttonRef}
					type="submit"
					className="text-mycelium-lightgreen bg-mycelium-midgreen border-mycelium-lightgreen hover:bg-mycelium-lightgreen mx-auto mb-8 flex h-10 w-full max-w-xs items-center justify-center rounded-lg border text-sm font-medium transition-colors duration-300 hover:text-black lg:mt-0 lg:mb-0"
				>
					{submittedText}
				</button>
			</form>
