const MenuIcon: React.FC<{ navOpen: boolean; toggleNav: () => void }> = ({
  ...
  return (
    ...
    >
      <span
        className={`mb-[5px] h-[3px] w-[25px] transform-gpu bg-white transition-all duration-500 group-hover:bg-mycelium-lightgreen ${
          navOpen
      ...
      />
      <span
        className={`h-[3px] w-[25px] transform-gpu bg-white transition-all duration-500 group-hover:bg-mycelium-lightgreen ${
