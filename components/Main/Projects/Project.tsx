			...
			<Container className="flex min-h-[400px] flex-col-reverse justify-between xl:max-h-[calc(100vh-280px)] xl:flex-row xl:pt-5 2xl:pt-0">
				<div className="mr-12 flex w-full flex-grow flex-col justify-between leading-7 xl:max-w-[530px]">
					<div className="mb-16 hidden text-white xl:mb-10 xl:block">
						<h1 className="mb-4 text-3xl 2xl:text-5xl">Our projects</h1>
						<p className="text-[16px] leading-5">
							Mycelium is focused on building and running market infrastructure
							that powers the financial world of tomorrow.
						</p>
					</div>
					{/* Mobile image */}
					...
					<div className="my-16 xl:my-0">
						...
						<p className="text-[16px] leading-7 text-mycelium-lightgreen">
							{description}
						</p>
						<a
							href={link}
							target="_blank"
							rel="noopener"
							className="group mt-6 block text-[16px] text-mycelium-lightgreen"
						>
							Visit website
