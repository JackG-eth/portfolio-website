	...
	return (
		<div id="projects">
			<section id="pinMaster" className="z-10">
				<div
					id="pinContainer"
					className="relative z-10 w-screen transform-gpu justify-center pt-10 xl:h-screen xl:w-screen"
				>
					<section className="overflow-x-hiddenxl:absolute pointer-events-none top-0 left-0 z-0 flex w-screen items-center xl:h-screen">
